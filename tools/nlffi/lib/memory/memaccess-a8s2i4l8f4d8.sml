...
structure CMemAccess : CMEMACCESS = struct
    ...
    val load_ulong = InlineT.Word64.intern o MemAccess64.load2
    val load_slong = InlineT.Int64.intern o MemAccess64.load2
    ...
    fun store_ulong (a, x) = MemAccess64.store2 (a, InlineT.Word64.extern x)
    fun store_slong (a, x) = MemAccess64.store2 (a, InlineT.Int64.extern x)
