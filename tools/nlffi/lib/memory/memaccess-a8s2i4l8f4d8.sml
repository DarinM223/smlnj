...
structure CMemAccess : CMEMACCESS = struct
    ...
    type addr = Word64.word
    val null = 0w0 : addr
    fun isNull a = a = null
    infix ++ --
    (* rely on 2's-complement for the following... *)
    fun (a: addr) ++ i = a + Word64.fromInt i
    val compare = Word64.compare
    fun a1 -- a2 = Word64.toIntX (a1 - a2)
    ...
    val load_ulong = RawMemInlineT.w64l
    val load_slong = RawMemInlineT.i64l
    val load_ulonglong = RawMemInlineT.w64l
    val load_slonglong = RawMemInlineT.i64l
    ...
    val store_ulong = RawMemInlineT.w64s
    val store_slong = RawMemInlineT.i64s
    val store_ulonglong = RawMemInlineT.w64s
    val store_slonglong = RawMemInlineT.i64s
    ...
    type cc_slong = Int64.int
    type cc_ulong = Word64.word
